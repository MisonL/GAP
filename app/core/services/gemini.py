...
# 导入应用内部的模型和工具类
from app.api.models import ChatCompletionRequest # OpenAI 格式的聊天请求模型
from app.core.utils.response_wrapper import ResponseWrapper # 用于包装和处理 Gemini 响应的工具类 (新路径)
