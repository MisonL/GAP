...
key_scores_cache: Dict[str, Dict[str, float]] = defaultdict(lambda: defaultdict(float)) # Key 分数缓存
...
daily_rpd_totals: Dict[str, int] = defaultdict(int) # 每日 RPD 总计
