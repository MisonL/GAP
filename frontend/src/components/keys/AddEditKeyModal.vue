  ...
  >
    <div class="modal-content">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div
          v-if="isEditMode || !isKeyProtected"
        ...
        >
          <input
            ...
            type="checkbox"
            :disabled="isKeyProtected && isEditMode"
          >
          <label for="is_active">激活状态</label>
          <small
            v-if="isKeyProtected && isEditMode"
          >
            (管理员 Key 不能被禁用)
          </small>
        </div>
        ...
        <div class="form-group checkbox-group">
          <input
            id="enable_context_completion"
            v-model="form.enable_context_completion"
            type="checkbox"
          >
